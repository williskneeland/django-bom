...
bom_patterns = [
    ...
    path('create-part-class-workflow/', views.create_part_class_workflow, name='create-part-class-workflow'),
    path('edit-part-class-workflow/<int:workflow_id>/', views.create_part_class_workflow, name='part-class-workflow-edit'),
    path('workflow-state-edit/<int:state_id>/', views.workflow_state_edit, name='workflow-state-edit'),
...
urlpatterns = [
    ...
    path('bom/login/', auth_views.LoginView.as_view(), {'redirect_authenticated_user': True, }, name='login'),
